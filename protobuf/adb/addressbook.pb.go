...
// define an AddressBook message which has Person field repeated any number of
// times
...
// embedded message definition, accessible only by the outer message
type Person_PhoneNumber struct {
	...
	Type   Person_PhoneType `protobuf:"varint,2,opt,name=type,proto3,enum=adb.Person_PhoneType" json:"type,omitempty"`
}
...
var file_addressbook_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x03, 0x61, 0x64, 0x62, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74,
	0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb1, 0x02, 0x0a, 0x06, 0x50, 0x65,
	...
	0x2e, 0x61, 0x64, 0x62, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x2e, 0x50, 0x68, 0x6f, 0x6e,
	...
	0x70, 0x52, 0x0b, 0x6c, 0x61, 0x73, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x1a, 0x50,
	...
	0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e, 0x61, 0x64, 0x62, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e,
	...
	0x64, 0x62, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x52, 0x06, 0x70, 0x65, 0x6f, 0x70, 0x6c,
	0x65, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x61, 0x64, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_addressbook_proto_goTypes = []interface{}{
	(Person_PhoneType)(0),         // 0: adb.Person.PhoneType
	(*Person)(nil),                // 1: adb.Person
	(*AddressBook)(nil),           // 2: adb.AddressBook
	(*Person_PhoneNumber)(nil),    // 3: adb.Person.PhoneNumber
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_addressbook_proto_depIdxs = []int32{
	3, // 0: adb.Person.phones:type_name -> adb.Person.PhoneNumber
	4, // 1: adb.Person.last_updated:type_name -> google.protobuf.Timestamp
	1, // 2: adb.AddressBook.people:type_name -> adb.Person
	0, // 3: adb.Person.PhoneNumber.type:type_name -> adb.Person.PhoneType
